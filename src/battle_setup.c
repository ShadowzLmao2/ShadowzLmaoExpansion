...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, TRAINER_RED_DOUBLES, MAP_EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, TRAINER_WALLY_DOUBLES, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, MAP_EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_LEAF, TRAINER_LEAF, TRAINER_LEAF, TRAINER_LEAF, TRAINER_LEAF, MAP_EVER_GRANDE_CITY),
...
static inline bool32 IsRematchForbidden(s32 rematchTableId)
{
    if (rematchTableId >= REMATCH_ELITE_FOUR_ENTRIES)
        ...
        return !FlagGet(FLAG_WALLY_VICTORY_ROAD);
    else
        return FALSE;
}
