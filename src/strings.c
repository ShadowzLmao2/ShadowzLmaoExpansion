...
const u8 gText_LevelCap[] = _("The Pokemon is at the level cap.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AlreadySavedFile_Chat[] = _("Overwrite your old save?");
...
const u8 gText_Raikou[] = _("Raikou");
const u8 gText_Entei[] = _("Entei");
const u8 gText_Suicune[] = _("Suicune");
//Gen 4
...
const u8 gText_TornadusI[] = _("Tornadus Incarnate");
const u8 gText_TornadusT[] = _("Tornadus Therian");
const u8 gText_LandorusI[] = _("Landorus Incarnate");
...
const u8 gText_Necrozma[] = _("Necrozma");
//Gen 8
...
const u8 gText_Regidrago[] = _("Regidrago");
const u8 gText_Regieleki[] = _("Regieleki");
const u8 gText_BurnDrive[] = _("Burn Drive");
const u8 gText_ChillDrive[] = _("Chill Drive");
const u8 gText_DouseDrive[] = _("Douse Drive");
const u8 gText_ShockDrive[] = _("Shock Drive");
...
const u8 gText_InflictStatus[] = _("Inflict Status");
const u8 gText_RelearnMove[] = _("Relearn Move");
const u8 gText_SAPatch[] = _("Get a Hidden Ability");
const u8 gText_EVItems[] = _("EV Boosting Items");
const u8 gText_NatureMint[] = _("Get a Nature Mint");
const u8 gText_ChiYu[] = _("Chi Yu");
const u8 gText_ChienPao[] = _("Chien Pao");
const u8 gText_WoChien[] = _("Wo Chien");
const u8 gText_TingLu[] = _("Ting Lu");
const u8 gText_Singles[] = _("Singles");
const u8 gText_Doubles[] = _("Doubles");
const u8 gText_NatureAtk[]  = _("Atk Boosting");
const u8 gText_NatureDef[]  = _("Def Boosting");
const u8 gText_NatureSpA[]  = _("SpA Boosting");
const u8 gText_NatureSpD[]  = _("SpD Boosting");
const u8 gText_NatureSpe[]  = _("Spe Boosting");
...
const u8 gText_Modest[] = _("Relaxed");
...
const u8 gText_HP_EV[]  = _("80 HP EVs");
const u8 gText_ATK_EV[] = _("80 Atk EVs");
const u8 gText_DEF_EV[] = _("80 Def EVs");
const u8 gText_SPA_EV[] = _("80 SpA EVs");
const u8 gText_SPD_EV[] = _("80 SpD EVs");
const u8 gText_SPE_EV[] = _("80 Spe EVs");
