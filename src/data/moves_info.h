...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "A sharp wind move that cuts\n"
            "the foe from all directions."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_FLASH] =
    {
        .name = COMPOUND_STRING("Flash n Flee"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STONE_AXE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Sets splinters that hurt\n"
            "the foe when switching."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_ROCK,
        .accuracy = 95,
